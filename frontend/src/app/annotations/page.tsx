...
const AnnotationPage = () => {
  ...
  const [currentUser, setCurrentUser] = useState<User>({ name: '', id: -1, role: '' });
  ...
  return (
    <>
      ...
      <main className="d-flex">
        <section className="left-column">{projectData && <LoadXML project={projectData} onTextSelection={handleTextSelection} allowSelect={allowSelect} />}</section>
        <section className="right-column">
          {isTextSelected ? (
            ...
            <CreateAnnotation
              ...
              onAnnotationSaved={handleAnnotationSaved} // Pass the callback
            ...
            <AnnotationView onAnnotationDelete={handleAnnotationDeleted} retrieveAnnotations={retrieveAnnotations} isLoading={isLoading} handleAnnotationSaved={handleAnnotationSaved} />
          )}
        </section>
      </main>
    </>
