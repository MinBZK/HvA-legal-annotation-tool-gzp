    ...
    return (
      <>
        ...
        >
          ...
          <Modal.Body>
            {users.map((user) => (
              <div className="user-select mb-1" key={user.id}>
                <div>
                  <span>{user.role}</span>
                  <span>{user.name}</span>
                </div>
                <div>
                  ...
                  >
                    {activeUserId == user.id ? 'Geselecteerd' : 'Selecteer'}
                  </button>
                  <button
          ...
          <Modal.Footer>
            <button className="new-user" onClick={handleNewUserModal}>
            ...
            <Form.Group controlId="userRole" className="mt-2">
              ...
              >
                ...
                {roles.map((role, index) => (
                  <option value={role.toString()} key={index}>
                    {role}
                  </option>
                ))}
              </Form.Select>
